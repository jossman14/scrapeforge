"""
Alembic env.py — supports both offline (SQL dump) and online (async) migrations.

Run migrations:
  alembic -c api/alembic.ini upgrade head
  alembic -c api/alembic.ini downgrade base
...
from api.db.models import Base  # noqa: F401
...
def run_migrations_offline() -> None:
    """Emit SQL to stdout without a live DB connection (useful for review/audit)."""
